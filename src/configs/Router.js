    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route path="/auth/confirm_password_login" component={ConfirmPasswordLogin} />
          <PrivateRoute exact path="/profile/seller/product" component={SellerProduct} />
          <PrivateRouteUser exact path="/profile/custommer" component={ProfileCust} />
          <PrivateRoute path="/profile/seller/add_product" component={AddProduct} />
          <Route exact path="/products/:id" render={(props) => <Product {...props} />} />
          <PrivateRouteUser path="/profile/custommer/shipping_address" component={ShippingAddressCust} />
          <PrivateRouteUser path="/profile/custommer/my_order" component={CustOrder} />
          <PrivateRoute path="/profile/seller/update_product/:id" component={UpdateProduct} />
          <PrivateRoute exact path="/profile/seller" component={ProfileSeller} />
          <Route path="/category/:id" component={Category} />
          <PrivateRoute path="/profile/seller/myorderseller" component={SellerOrder} />
        </Switch>
      </BrowserRouter>
    );
  }
